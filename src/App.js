...
//function to show and hide Add contact div
 NewContact(){
    if(this.state.isclicked1){
    console.log("showing");
    this.setState({
      showResults:true,
      isclicked1:false,
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1 style={{ textAlign: "center", color:"brown" }}>React Contact List App</h1>
        <br />
        <button style={{ textAlign: "center", color:"white",border:"1px solid brown", width:"130px", borderRadius:"5px",backgroundColor:"green",fontWeight:"bolder" }} onClick={this.NewContact}>Add contact</button>
        { this.state.showResults ? <div id="Add-contact" >
      ...
      :""
        ...
        <br />
        <button  style={{ textAlign: "center", color:"white",border:"1px solid brown", width:"130px", borderRadius:"5px",backgroundColor:"blue",fontWeight:"bolder",marginTop:"30px" }} onClick={this.UpdateContact}>Update contact</button>
        { this.state.showdiv ? <div id="update-contact" >
